...
import type { AsepriteData, Asset, BitmapFontData, initAssets, LoadBitmapFontOpt, LoadSpriteOpt, LoadSpriteSrc, ShaderData, SoundData, SpriteAtlasData, SpriteData, Uniform } from "./assets";
import type { FontData } from "./assets/font";
import type { AudioCtx, AudioPlay, AudioPlayOpt } from "./audio";
import type { AgentComp, AgentCompOpt, AnchorComp, AnimateComp, AnimateCompOpt, AreaComp, AreaCompOpt, AreaEffectorComp, AreaEffectorCompOpt, BodyComp, BodyCompOpt, BuoyancyEffectorComp, BuoyancyEffectorCompOpt, CircleComp, CircleCompOpt, ColorComp, ConstantForceComp, ConstantForceCompOpt, DoubleJumpComp, FixedComp, FollowComp, HealthComp, LayerComp, LifespanCompOpt, MaskComp, NamedComp, OffScreenComp, OffScreenCompOpt, OpacityComp, OutlineComp, PathfinderComp, PathfinderCompOpt, PatrolComp, PatrolCompOpt, PointEffectorComp, PointEffectorCompOpt, PolygonComp, PolygonCompOpt, PosComp, RectComp, RectCompOpt, RotateComp, ScaleComp, SentryCandidates, SentryComp, SentryCompOpt, ShaderComp, SpriteComp, SpriteCompOpt, StateComp, StayComp, SurfaceEffectorComp, SurfaceEffectorCompOpt, TextComp, TextCompOpt, TextInputComp, TileComp, TileCompOpt, TimerComp, UVQuadComp, ZComp } from "./components/";
import type { EmitterOpt, ParticlesComp, ParticlesOpt } from "./components/draw/particles";
import type { BoomOpt, Game, GameObjEventMap, GameObjEventNames, LevelOpt, SceneDef, SceneName, TupleWithoutFirst } from "./game";
import type { AppGfxCtx, DrawBezierOpt, DrawCircleOpt, DrawCurveOpt, DrawLineOpt, DrawLinesOpt, DrawRectOpt, DrawSpriteOpt, DrawTextOpt, DrawTriangleOpt, FormattedText, FrameBuffer, LineCap, LineJoin, Texture } from "./gfx";
import type { Color, RGBAValue, RGBValue } from "./math/color";
import type { Circle, Ellipse, Line, Mat4, Point, Polygon, Quad, RaycastResult, Rect, RNG, StepPosition, Vec2, Vec2Args } from "./math/math";
...
export interface KAPLAYCtx<TButtonDef extends ButtonsDef = {}, TButton extends string = string> {
     ...
     * @group Components
     */
    sprite(spr: string | SpriteData | Asset<SpriteData>, options?: SpriteCompOpt): SpriteComp;
    /**
     ...
     * @group Events
     */
    on<Ev extends GameObjEventNames | (string & {})>(event: Ev, tag: Tag, action: (obj: GameObj, ...args: TupleWithoutFirst<GameObjEventMap[Ev]>) => void): KEventController;
    /**
