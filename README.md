...
Для этой практики я (Владимир Игоревич) специально добавил в игру несколько багов. Ваша задача — протестировать игру, выявить все баги, исправить их, задокументировать процесс и создать простые unit-тесты. В коде размещены подсказки в виде комментариев (например, `// BUG HERE` или `// HINT`), которые помогут найти проблемные места.
...
**Срок сдачи**: 30 сентября 2025 (или по договорённости).

Удачи! Вопросы — на занятии или в чате группы. 🚀